...
class AutorizacionEmpleado extends Model
{
    ...
    {
      return $this->belongsTo(User::class, 'creado_by');
    }
    ...
    {
      return $this->hasManyThrough(User::class, Marcacion::class, 'id', 'id', 'id_marcacion', 'id_user');
    }
    public function getTpMarcacion()
    {
      return $this->hasManyThrough(TpMarcacion::class, Marcacion::class, 'id', 'id', 'id_marcacion', 'id_tp_marcacion');
    }
