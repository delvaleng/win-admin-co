  ...
  table = $('#tpMarcacions-table').DataTable({
           ...
           'language': {
            ...
            'columns'     : [
             ...
             '<a href="/tpMarcacions/'+data+'"      class="btn btn-default btn-xs"><i class="glyphicon glyphicon-eye-open"></i></a>'+
             '<a href="/tpMarcacions/'+data+'/edit" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-edit"></i></a>'+
             '</div>';
             }},
             {data:"descripcion",
             "render": function (data, type, row) {
