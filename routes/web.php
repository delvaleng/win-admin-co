...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::resource('tp-pagos',                           'General\TpPagoController'  );
	Route::resource('tp-cuentas',                         'General\TpCuentaController');
	Route::resource('tp-bancos',                          'General\TpBancoController' );
